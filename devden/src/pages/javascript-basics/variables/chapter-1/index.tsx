...
//     { type: 'challenge', initialInput: 'console.log(1);' },
...
//   const renderComponent = (component: { type: string; text?: string; texts?: string[]; code?: string; initialInput?: string; question?: string; codeSnippet?: string; options?: Option[]; correctAnswer?: string }, index: number) => {
//     switch (component.type) {
//       case 'challenge':
//         return <Challenge initialInput={component.initialInput || ''} onSuccess={() => handleChallengeSuccess(components.indexOf(component))} />;
//       case 'text':
//         return component.code ? (
//           <TextComponent code={component.code} />
//         ) : (
//           component.text ? <TextComponent text={component.text} /> : null
//         );
//       case 'input':
...
const Chapter1: React.FC = () => {
  ...
  const renderComponent = (component: { type: string; text?: string; texts?: string[]; code?: string; initialInput?: string; editableLines?: boolean[]; question?: string; codeSnippet?: string; options?: Option[]; correctAnswer?: string }, index: number) => {
    switch (component.type) {
      case 'challenge':
        return <Challenge
